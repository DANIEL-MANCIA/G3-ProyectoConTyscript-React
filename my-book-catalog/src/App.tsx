...
const COMPANY_NAME = 'DMAN - Tu Biblioteca Digital';
const AUTHOR = 'JOSUÉ DANIEL MANCIA FLORES';
const STUDENT_CODE = 'MF22I04001';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-200">
      ...
      <footer className="bg-black text-white p-4 text-center font-medium">
        <p>{AUTHOR} | Código: {STUDENT_CODE} | Fecha: {DATE}</p>
      </footer>
